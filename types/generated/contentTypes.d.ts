...
export interface ApiActuActu extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    tags: Schema.Attribute.Component<'repeatable.tags', true>;
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    auteur: Schema.Attribute.Relation<'manyToOne', 'api::auteur.auteur'>;
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::article.article'
    >;
    publised_at: Schema.Attribute.DateTime & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiCommandeCommande extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    livraison: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiProchaineMarmiteProchaineMarmite
  ...
  attributes: {
    ...
    disponibilite: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
